...
#define MISC_ENABLE_FAST_STRING			(1UL << 0U)
#define MISC_ENABLE_TCC				(1UL << 3U)
#define MISC_ENABLE_PMA				(1UL << 7U)
#define MISC_ENABLE_BTS_UNAVAIL			(1UL << 11U)
#define MISC_ENABLE_PEBS_UNAVAIL		(1UL << 12U)
#define MISC_ENABLE_TM2_ENABLE			(1UL << 13U)
#define MISC_ENABLE_EITS			(1UL << 16U)
#define MISC_ENABLE_MONITOR_ENA			(1UL << 18U)
#define MISC_ENABLE_LIMIT_CPUID			(1UL << 22U)
#define MISC_ENABLE_xTPR			(1UL << 23U)
#define MISC_ENABLE_XD_DISABLE			(1UL << 34U)
